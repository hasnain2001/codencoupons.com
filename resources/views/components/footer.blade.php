            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="contact-info">
                    ...
                    <li>
                        ...
                        <div>
                            <strong>Email:</strong>
                           <a href="mailto: contact@codencoupons.com" class="text-light text-decoration-none"> contact@codencoupons.com</a>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    <p class="copyright mb-0">
                        &copy; {{ date('Y') }} <a href="http://codencoupons.com" target="_blank" class="text-light">codencoupons</a>. All rights reserved.
                    </p>
                </div>
                <div class="col-md-6">
