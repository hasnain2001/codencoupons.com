...
@section('description','Learn more about codencoupons, your go-to source for the best deals and discounts. Discover our mission, values, and how we help you save more.')
...
<div class="container text-capitalized ">
    ...
    <div class="about-content">
        <h1 class="page-heading">Welcome to codencoupons</h1>
        ...
        <div class="stats-section">
            <div class="container">
                ...
                <p style="color: rgba(255,255,255,0.95); font-size: 1.1rem; max-width: 600px; margin: 0 auto;">
                    Join thousands of satisfied users who trust codencoupons for their savings journey
                </p>
