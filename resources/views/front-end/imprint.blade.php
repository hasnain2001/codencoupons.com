                ...
                <div class="imprint-card">
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-content">
                            <p class="mb-2"><strong>codencoupons Ltd.</strong></p>
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-content">
                            <div class="contact-highlight">
                                <p class="mb-2">
                                    <strong>Email:</strong>
                                    <a href="mailto:contact@codencoupons.com">contact@codencoupons.com</a>
                                </p>
                                <p class="mb-0">
                                    <strong>Phone:</strong>
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-content">
                            <p class="mb-3">Through this website you are able to link to other websites which are not under the control of codencoupons Ltd. We have no control over the nature, content, and availability of those sites. The inclusion of any links does not necessarily imply a recommendation or endorse the views expressed within them.</p>
                            <p class="mb-0">Every effort is made to keep the website up and running smoothly. However, codencoupons Ltd. takes no responsibility for, and will not be liable for, the website being temporarily unavailable due to technical issues beyond our control.</p>
                        </div>
                    </div>
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-content">
                            <p class="mb-3">© {{ date('Y') }} codencoupons Ltd. All rights reserved.</p>
                            <p class="mb-0">All content, including but not limited to text, graphics, logos, button icons, images, audio clips, digital downloads, data compilations, and software, is the property of codencoupons Ltd. or its content suppliers and protected by international copyright laws.</p>
                        </div>
                    </div>
